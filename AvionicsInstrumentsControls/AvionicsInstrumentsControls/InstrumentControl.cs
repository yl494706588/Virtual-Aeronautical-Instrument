...
namespace AvionicsInstrumentControlDemo
{
    public class InstrumentControl : System.Windows.Forms.Control
    {
        ...
        public void RotateImage(PaintEventArgs pe, Image img, Double alpha, Point ptImg, Point ptRot, float scaleFactor)
        {
		...
		/// <param name="ptImg">The location of the left upper corner of the image to display in the paint area in nominal situation</param>
		/// <param name="scaleFactor">Multiplication factor on the display image</param>
        public void TranslateImage(PaintEventArgs pe, Image img, int deltaPx, float alpha, Point ptImg, float scaleFactor)
        {
            // Computed offset
		...
		/// <param name="ptRot">The location of the rotation point in the paint area</param>
		/// <param name="scaleFactor">Multiplication factor on the display image</param>
        public void RotateAndTranslate(PaintEventArgs pe, Image img, Double alphaRot, Double alphaTrs, Point ptImg, int deltaPx, Point ptRot, float scaleFactor)
        {
            double beta = 0;
            double d = 0;
            float deltaXRot = 0;
		...
		/// <param name="ptImg">The location of the left upper corner of the image to display in the paint area in nominal situation</param>
		/// <param name="scaleFactor">Multiplication factor on the display image</param>
        public void ScrollCounter(PaintEventArgs pe, Image imgBand, int nbOfDigits, int counterValue, Point ptImg, float scaleFactor)
        {
            int indexDigit =0;
        ...
        public Point FromCartRefToImgRef(Point cartPoint)
        {
        ...
        public double FromDegToRad(double degAngle)
        {
    ...
    public struct InstrumentControlMarkPoint
    {
